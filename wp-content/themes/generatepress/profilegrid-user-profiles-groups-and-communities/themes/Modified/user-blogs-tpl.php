...
//print_r($include_blog);die;

if(isset($include_blog) && $include_blog=="true"){$post_type = array('profilegrid_blogs','post');}else{$post_type = 'profilegrid_blogs';}
...
<div id="pg-user-blog" class="pm-difl test">
    ...
    else
    {
        ...
        _e('User Blogs are disabled at the moment. Please contact the site administrator for more information.','profile-magic');
        echo '</div>';
