   ...
   <div class="pm-all-group-container pm-dbfl">
    ...
    ?>
        <div class="pm-group pm-difl pm-border pm-radius5 pm-bg-lt pm50">
          <div class="pm-group-heading pm-dbfl pm-border-bt pm-pad10 pm-clip"><a href="<?php echo esc_url( $group_url ); ?>"><?php echo $group->group_name;?></a></div>
          ...
          <div class="pm-group-button pm-dbfl pm-pad10">
           <div class="pm-group-signup"><a href="<?php echo $registration_url;?>" class="pm_button"><button><?php _e('Join Group','profile-magic');?></button></a></div>
            ...
            <?php else: ?>
            <div class="pm_free_group"><?php _e('Free','profile-magic');?></div>
            <?php endif; ?>
            </div>
           <?php else: ?>
          <div class="pm-group-button pm-dbfl pm-pad10">
           <div class="pm-group-signup">
               <a href="<?php echo $group_url;?>" class="pm_button">
                   <button><?php _e('Details','profile-magic');?></button>
               </a>
           </div>
          </div>
          <?php endif;?>
