    	...
    	FileAPI.event.on(filechooser, 'change', function (evt){
          ...
          FileAPI.filterFiles(files, function (file, info/**Object*/){
            ...
            if( file.size <= size_in_bytes){
                ...
                var msg_local = wpfm_file_vars.messages.file_size_error + wpfm_file_vars.max_file_size;
...
function render_html_file_data(fileid, class_name, file_name, amazon_data, file_groups){
   ...
   .append('<input type="text" name="uploaded_files['+fileid+'][title]" class="form-control" placeholder="Title" value="'+file_name+'">');
