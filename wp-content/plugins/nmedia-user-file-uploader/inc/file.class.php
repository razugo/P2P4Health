...
class WPFM_File {
    ...
    function thumb_image() {
        ...
        //code of interest for thumbnails
        ...
        if ( $this->is_dir() ) {
            ...
            $h = 50;
            $w = 50;
            $thumb_url = WPFM_URL."/images/_blank.png";
        }elseif ( wpfm_is_pdf($this->name) ) {

            $thumb_url = WPFM_URL."/images/pdf.png";
        }elseif ( wpfm_is_image($this->name) ) {
            
            $thumb_url = WPFM_URL."/images/picture.png";
        }else {
    ...
    */
    ...
    function download_button() {
        ...
        //********** TEST CODE Capstone 2019 **********
        //code of interest
        //submit download form to this page
