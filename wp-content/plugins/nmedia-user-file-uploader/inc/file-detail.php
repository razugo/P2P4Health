                ...
                $html .= '<div class="table-responsive">';
                    $html .= '<table class="table table-bordered table-striped">';
                        $html .= '<tbody>';
                            ...
                            $html .= '</tr>';
                            $html .= '<tr>';
                                $html .= '<td><b>'.__('Total Downloads').'</b></td>';
                            $html .= '</tr>';
                            $html .= '<tr>';
                                $html .= '<td>'.$file->total_downloads.'</td>';
                            $html .= '</tr>';
                            $html .= '<tr>';
                                $html .= '<td><b>'.__( "Post Date", "wpfm" ).'</b></td>';
                            $html .= '</tr>';
                            $html .= '<tr>';
                        ...
                        $html .= '<div class="col-sm-12">';
                            $html .= '<div class="meta-inforation">';
                                $html .= '<div class="panel panel-primary meta-info">';
                                    ...
                                    $html .= '</div>';
                                $html .= '</div>';
                                $html .= '<div class="meta-edit-from">';
                                    $html .= '<h4 class="modal-title">'.__('Edit Meta', 'wpfm').'</h4>';
                        ...
                        $html .= '<div class="panel-body">';
                            $html .= '<form class="form-horizontal wpfm-send-file-in-email">';
                                ...
                                $html .= '<div class="form-group">';
                                    ...
                                    $html .= '<div class="col-sm-10"><input required type="email" class="form-control" name="emailaddress" id="emailaddress"></div>';
                                $html .= '</div>';
                                $html .= '<div class="form-group">';
                                    $html .= '<label class="col-sm-2 control-label" for="subject">'.__('Subject','wpfm').'</label>';
                                    $html .= '<div class="col-sm-10"><input required type="text" class="form-control" name="subject" id="subject"></div>';
                                $html .= '</div>';
                                $html .= '<div class="form-group">';
