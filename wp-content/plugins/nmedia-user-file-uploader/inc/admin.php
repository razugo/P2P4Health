...
function wpfm_admin_load_scripts( $hook ){
	...
	global $post;
    if ( ( isset($post) && 'wpfm-files' === $post->post_type) || $hook == 'toplevel_page_wpfm' || $hook == 'users.php' || $hook == "wpfm-files_page_wpfm-settings" ) {
        // AnimateModal
		...
		wp_enqueue_script( 'wpfm-swal', WPFM_URL .'/js/swal/sweetalert.min.js', array('jquery'));
