...
<div class="pm-section pm-dbfl" id="pg-friends-container">
 ...
 <div class="pm-section-left-panel pm-section-nav-vertical pm-difl">
    ...
    <ul class="dbfl">
        <li class="pm-dbfl pm-border-bt pm-pad10"><a class="pm-dbfl" href="#pg-myfriends"><?php _e('My Friends','profile-magic');?><span class="pm-difr notification-count"><?php echo $total_myfriends;?></span></a></li>
        <li class="pm-dbfl pm-border-bt pm-pad10"><a class="pm-dbfl" href="#pg-friend-requests"><?php _e('Friend Requests','profile-magic');?><span class="pm-difr notification-count"><?php echo $total_myfriends_requests;?></span></a></li>
        <li class="pm-dbfl pm-border-bt pm-pad10"><a class="pm-dbfl" href="#pg-requests-sent"><?php _e('Requests Sent','profile-magic');?><span class="pm-difr notification-count"><?php echo $total_send_requests;?></span></a></li>
    </ul>
</div>
