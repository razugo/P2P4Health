...
{
    echo '<div class="pg-alert-warning pg-alert-info">'.__( 'There are no user groups available right now. If you are admin, you can create one from dashboard and start signing up users.','profile-magic' ).'</div>'; 
}
?>