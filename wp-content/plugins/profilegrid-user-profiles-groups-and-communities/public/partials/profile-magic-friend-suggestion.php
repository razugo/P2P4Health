...
if(empty($suggestions)){
    echo '<p class="pm-no-result-found">'.__('No suggestions available for friends','profile-magic').'</p>';
}else{
...
<input type="submit" name="pm_u_search_button" id="pm_u_search_button" value="<?php _e('Search','profile-magic');?>" />
</form>
</div>
...
<button id="pm_load_more_suggestion" value="2" onclick="pm_load_more_suggestion(<?php echo $uid;?>,this.value,<?php echo $num_of_suggestions_pages;?>)"><?php _e('Load More Result','profile-magic');?></button>
