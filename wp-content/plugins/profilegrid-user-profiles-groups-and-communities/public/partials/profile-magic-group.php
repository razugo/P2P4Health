...
if(isset($_POST['remove_image']))
{
	...
	if (!wp_verify_nonce($retrieved_nonce, 'save_pm_edit_group' ) ) die( __('Failed security check','profile-magic') );
...
{
        echo '<div class="pmrow pg-alert-info pg-alert-warning">'.__( 'Sorry, this group is currently not accessible. Either it was deleted or its ID does not matches.','profile-magic' ).'</div>'; 
}
endif;
?>
