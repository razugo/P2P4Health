...
if(!empty($requests))
{
	...
	<button id="pm_load_more_request" value="2" onclick="pm_load_more_request(<?php echo $uid;?>,this.value,<?php echo $num_of_requests_pages;?>)"><?php _e('Load More Result','profile-magic');?></button>
...
{
	echo '<p class="pm-no-result-found">'.__('No new requests','profile-magic').'</p>';
