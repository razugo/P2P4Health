...
<form class="pmagic-form pm-dbfl" method="post" action="" id="pm_my_account" name="pm_my_account" onsubmit="return pm_save_account_setting(this);">
     <div class="pmrow">        
        <div class="pm-col">
            ...
            <div class="pm-field-lable">
                <label for="user_name"><?php _e('Username','profile-magic');?><sup class="pm_estric">*</sup></label>
            </div>
     ...
     <div class="pmrow">        
        <div class="pm-col">
            <div class="pm-form-field-icon"></div>
            <div class="pm-field-lable">
                <label for="first_name"><?php _e('First Name','profile-magic');?></label>
            </div>
    ...
    <div class="pmrow">        
        <div class="pm-col">
            <div class="pm-form-field-icon"></div>
            <div class="pm-field-lable">
                <label for="last_name"><?php _e('Last Name','profile-magic');?></label>
            </div>
            <div class="pm-field-input">
    ...
    <div class="pmrow">        
        <div class="pm-col">
            <div class="pm-form-field-icon"></div>
            <div class="pm-field-lable">
                <label for="user_email"><?php _e('Email','profile-magic');?><sup class="pm_estric">*</sup></label>
            </div>
            <div class="pm-field-input pm_email pm_user_email pm_required">
                ...
                if(isset($error)){
                    ...
                    $account_error = __("This email is already registered. Please try with different email.",'profile-magic');
                    }
                    if($error == 'no_changes')
                    {
                     $account_error = __("No changes were made to the account details to be saved.",'profile-magic');
                    }
