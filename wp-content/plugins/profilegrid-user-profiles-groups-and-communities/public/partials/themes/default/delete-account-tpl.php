...
<form class="pmagic-form pm-dbfl" method="post" action="" id="pm_delete_account" name="pm_delete_account" onsubmit="return pm_delete_account_setting(this);">
     <div class="pmrow pg-alert-info pg-alert-danger">       
        <?php echo $dbhandler->get_global_option_value('pm_account_deletion_alert_text',__('Are you sure you want to delete your account? This will erase all of your account data from the site. To delete your account enter your password below','profile-magic'));?>
    </div>
     <div class="pmrow">        
        <div class="pm-col">
            <div class="pm-form-field-icon"></div>
            <div class="pm-field-lable">
                <label for="password"><?php _e('Password','profile-magic');?></label>
            </div>
    ...
    <div class="buttonarea pm-full-width-container">
      ...
      <input type="submit" value="<?php _e('Submit','profile-magic');?>" name="pm_delete_account">
    </div>
  </form>
</div>