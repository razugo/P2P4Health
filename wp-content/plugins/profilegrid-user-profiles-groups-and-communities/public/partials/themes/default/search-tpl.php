        ...
        <div class="pm-user-search pm-dbfl pm-border-bt pm-bg-lt">
            <form name="pm-search-form" id="pm-advance-search-form" method="post" class="pm-dbfl" >
                ...
                <div class="pm-adv-search-button pm-dbfl pm-pad10">
                    <input type="submit" form='unknown' id="reset_btn" name="pm_reset" class="pm-search-submit pm-difl"  value="<?php _e('Reset','profile-magic'); ?>" /> 
                    <input type="submit" form='unknown' id="advance_search_option" name="advance_search_button" class="pm-search-submit pm-difl"  value="<?php _e('Advance','profile-magic'); ?>" />
                </div>
                    ...
                    foreach ($fields as $field) {
                        ...
                        if (!in_array($field->field_type, $exclude)) {
                            ...
                            if (isset($field_options['display_on_search']) && ($field_options['display_on_search'] == 1)) {
                                ?>
                        <li class="pm-filter-item"><input type="checkbox" name="match_fields" onclick="pm_advance_user_search()"  value="<?php echo "$field->field_key"; ?>" ><span class="pm-filter-value"><?php _e($field->field_name,'profile-magic'); ?></span></li>
