...
class Profilegrid_Groups_Menu extends WP_Widget {
    ...
    public function __construct() {
        $widget_options = array(
          ...
          'description' => __('List ProfileGrid Groups','profile-magic'),
        );
        parent::__construct( 'pg_groups_menu', __('ProfileGrid Groups Menu','profile-magic'), $widget_options );
    }
    ...
    public function form($instance)
    {
        ...
        <p>
            <label><?php _e('Display Group Icon/Badge:','profile-magic');?></label>
        ...
        ?>
            <li id="<?php echo $group['id']; ?>">
                <div class="pm-custom-field-page-slab-widget pm-dbfl">
                    ...
                    <div class="pm-group-buttons"><input type="checkbox" <?php checked(in_array($group['id'], $group_list) , 1 ); ?> name="group-lists" value="<?php echo $group['id']; ?>"/></div>
                    <div class="pm-group-info"><?php echo $group['group_name']; ?></div>
                </div>
            </li>
        <?php
            endforeach;
        ...
        ?>
            <li>
                <div class="pm-slab"><?php _e("You haven't created any Profile Groups yet.",'profile-magic'); ?></div>
            </li>
        <?php
        endif;
        ?>
...
jQuery(function() {
    ...
    public function widget($args,$instance)
    {
        ...
        ?>
            <a href="<?php echo $group_url; ?>" class="pm-dbfl">
                <div class="pg-group-menu-slab pm-dbfl" >
                    <?php if ($pg_group_icon == 'yes'): ?>
                        <div class="pg-group-menu-img pm-difl">
                           <?php echo $pmrequests->profile_magic_get_group_icon($group,'',$path); ?>
                        </div>
                    <?php endif; ?>
