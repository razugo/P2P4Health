...
class Profilegrid_User_Blogs extends WP_Widget {
    ...
    public function __construct() {
        $widget_options = array(
          ...
          'description' => __('The widget will display User Blog posts.','profile-magic'),
        );
        parent::__construct( 'pg_user_blogs', __('Profilegrid User Blogs','profile-magic'), $widget_options );
    }
    ...
    public function form($instance)
    {
        ...
        <p>
            <label for="<?php echo $this->get_field_id( 'gid' ); ?>"><?php _e('Display User Blogs From:','profile-magic');?></label>
            <select class="widefat" id="<?php echo $this->get_field_id( 'gid' ); ?>" name="<?php echo $this->get_field_name( 'gid' ); ?>">
               <option value="all" <?php if($gid=='all'){echo 'selected';} ?>><?php _e('All Group','profile-magic'); ?></option>
         ...
         <p>
           <label for="<?php echo $this->get_field_id( 'post_counts' ); ?>"><?php _e('Number of Posts to Show:','profile-magic');?>
    ...
    public function widget($args,$instance)
    {
        ...
        ?>
            <div class="pm-slab"><?php _e("Group Members does not create any posts yet",'profile-magic'); ?></div>
        <?php
        endif;
