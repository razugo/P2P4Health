...
<div class="uimagic">
   <div class="content">
      <div class="uimheader"><?php _e('Registration Forms','profile-magic');?> </div>    
   </div>
    
    
<div class="uimrow"> 
    <div class="update-nag">   
        <?php printf(__('While ProfileGrid comes packed with its own forms, if you require a more robust and powerful form system you can optionally try our dedicated plugin - RegistrationMagic. It integrates perfectly with ProfileGrid and brings with itself a host of new features. <a href="%s" target="new">Click Here</a> to install it now. You can learn more about the integration <a href="%s" target="new">here</a>.', 'profile-magic'),$activateUrl,'https://profilegrid.co/profilegrid-registrationmagic-integration/'); ?>
    </div>  
