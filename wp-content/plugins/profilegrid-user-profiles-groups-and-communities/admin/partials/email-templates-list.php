...
if(isset($_GET['selected']))
{
	...
	foreach($selected as $tid)
	{
                ...
                if($exist_tmpl!=false)
                {
                    ...
                    {
                        $msg = sprintf(__('The Email Template you are trying to delete is being used for notifications by group %s. Disassociate the template before deleting.','profile-magic'),$exist_tmpl);
                    }  
                } 
                else
                {
...
<div class="pmagic"> 
  ...
  <form name="email_manager" id="email_manager" action="" method="get">
    ...
    <div class="operationsbar">
      <div class="pmtitle">
        <?php _e('Email Templates','profile-magic');?>
      </div>
      <div class="nav">
        <ul>
          <li><a href="admin.php?page=pm_add_email_template">
              <i class="fa fa-plus" aria-hidden="true"></i>
            <?php _e('New Template','profile-magic');?>
            </a></li>
            <li class="pm_action_button"><a>
                  <input type="submit" name="delete" value="<?php _e('Delete','profile-magic');?>" onclick="return check_is_tmpl_associate();" />
            </a></li>
    ...
    <div class="pmagic-table"> 
      ...
      <table class="pg-email-list">
        <tr>
          <th>&nbsp;</th>
            <th>&nbsp;</th>
          <th><?php _e('SR','profile-magic');?></th>
          <th><?php _e('Name','profile-magic');?></th>
          <th><?php _e('Subject','profile-magic');?></th>
...
<!--              <i class="fa fa-eye" aria-hidden="true"></i>-->
    ...
    <?php echo $pagination;?>
    <?php else:?>
	<div class="pm_message"><?php _e('You haven’t created any email templates yet. Why don’t you go ahead and create one now!','profile-magic');?></div>
	<?php endif;?>
  </form>
</div>
