...
<div class="pmagic"> 
  ...
  <div class="operationsbar">
    <div class="pmtitle">
      <?php _e('Users Profiles','profile-magic');?>
    </div>
   
    <div class="nav">
      <ul>
        <li><a href="user-new.php"><i class="fa fa-user-plus" aria-hidden="true"></i><?php _e("New User",'profile-magic');?></a></li>
        <li class="pm_action_button"><input type="submit" name="deactivate" value="<?php _e("Deactivate",'profile-magic');?>" /></li>
        <li class="pm_action_button"><input type="submit" name="activate" value="<?php _e("Activate",'profile-magic');?>" /></li>
        <li class="pm_action_button"><input type="button" name="delete" value="<?php _e("Delete",'profile-magic');?>" onclick="jQuery('.pm-delete-to-group').css('visibility', 'visible');" /></a></li>
        <li class="pm_action_button"><input type="button" name="move" value="<?php _e("Assign Group",'profile-magic');?>" onclick="jQuery('.pm-move-to-group').css('visibility', 'visible');" /></a></li>
        <li class="pm-form-toggle">
            ...
            <?php }
                          ?>
            <option value="0"><?php _e('None','profile-magic'); ?></option>
          </select>
        </li>
      </ul>      
    </div>
  ...
  <div class="pm-popup pm-move-to-group pm-popup-height-auto" >
       <div class="pm-popup-header">
            <div class="pm-popup-title"><?php _e('Assign to group','profile-magic');?>   </div>
      ...
      <div class="pm-popup-field-name" style="padding:15px;" >
               ...
               <input type="submit" name="move" value="<?php _e("Assign",'profile-magic');?>"style="padding-left:20px;"/>

               <p class="pm-warning"> <?php _e('You are adding this user(s) to new group. All data associated with profile fields of old group will be merged and the user will have to edit and fill profile fields associated with the new group.','profile-magic'); ?></p>
  ...
  <div class="pm-popup pm-delete-to-group pm-popup-height-auto" >
       <div class="pm-popup-header">
            <div class="pm-popup-title"><?php _e('Please Confirm','profile-magic');?>   </div>
                <img class="pm-popup-close" src="<?php echo $path;?>/images/close-pm.png">
       </div>
       
      <div class="pm-popup-field-name" style="padding:15px;" >
            <p class="pm-warning"> <?php _e('You are about to remove selected user(s) from their respective groups and delete their user accounts. This action is irreversible. Please confirm to proceed.','profile-magic'); ?></p>
      </div>
      <div class="modal-footer">
                 <input type="button" id="cancel-delete" class="pm-popup-close" value="<?php _e('Cancel','profile-magic');?> " />
                 <input type="submit" name="delete" value="<?php _e("Confirm",'profile-magic');?>" />
            </div>
    </div>
  <!--------Operationsbar Ends-----> 
  ...
  <div class="pmagic-table"> 
    ...
    <div class="sidebar">
      <div class="sb-filter"><?php _e("Search",'profile-magic');?>
      ...
      <?php endif;?>
      <div class="sb-filter"> <?php _e("Time",'profile-magic');?>
      <div class="filter-row">
        ...
        <div class="filter-row">
          ...
          <?php _e("Today",'profile-magic');?> </div>
        <div class="filter-row">
          ...
          <?php _e("Yesterday",'profile-magic');?> </div>
        <div class="filter-row">
          ...
          <?php _e("This Week",'profile-magic');?> </div>
        <div class="filter-row">
          ...
          <?php _e("Last Week",'profile-magic');?> </div>
        <div class="filter-row">
          ...
          <?php _e("This Month",'profile-magic');?> </div>
        <div class="filter-row">
          ...
          <?php _e("This Year",'profile-magic');?> </div>
        <div class="filter-row">
          ...
          <?php _e("Specific Period",'profile-magic');?> </div>
       ...
       <?php _e("Start Date",'profile-magic');?>
      ...
      <div class="sb-filter"> <?php _e("Status",'profile-magic');?>
       <div class="filter-row">
        ...
        <div class="filter-row">
          ...
          <?php _e("Active",'profile-magic');?> </div>
        <div class="filter-row">
          ...
          <?php _e("Inactive",'profile-magic');?> </div>
      </div>
      ...
      <div class="sb-filter"> <?php _e("Match Field",'profile-magic');?>
        <div class="filter-row">
        <?php
        ...
        <div class="filter-row">
          <input type="submit" name="result" value="<?php _e("Search",'profile-magic');?>">
          <input type="submit" name="reset" value="<?php _e("Reset",'profile-magic');?>">
        </div>
      </div>
    </div>
    <table>
      <tr>
        <th>&nbsp;</th>
        <th><?php _e('Image','profile-magic');?></th>
        <th><?php _e('Display Name','profile-magic');?></th>
      ...
      <?php
          ...
          <?php } 
                        ...
                        {
                            echo '<tr><td></td><td>';
                             _e('No user matches your search.','profile-magic');
