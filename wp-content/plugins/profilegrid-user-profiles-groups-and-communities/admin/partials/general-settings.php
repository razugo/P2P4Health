...
if(filter_input(INPUT_POST,'submit_settings'))
{
	...
	if (!wp_verify_nonce($retrieved_nonce, 'save_general_settings' ) ) die( __('Failed security check','profile-magic') );
...
<div class="uimagic">
    ...
    <div class="content">
      ...
      <div class="uimrow">
        ...
        <div class="uimnote"><?php _e('You can create new templates by copying and renaming "default" folder (&#128194;) inside "[plugin root]/public/partials/themes" to "[your current theme directory]/profilegrid-user-profiles-groups-and-communities/themes".','profile-magic');?></div>
      </div>
        
        <div class="uimrow">
        <div class="uimfield">
          <?php _e('Theme','profile-magic');?>
        </div>
        <div class="uiminput">
          <select name="pm_theme_type" id="pm_theme_type">
            <option value="light" <?php selected($dbhandler->get_global_option_value('pm_theme_type','light'),'light'); ?>><?php _e('Light','profile-magic');?></option>
            <option value="dark" <?php selected($dbhandler->get_global_option_value('pm_theme_type','light'),'dark'); ?>><?php _e('Dark','profile-magic');?></option>
        </select>
          <div class="errortext"></div>
        </div>
        <div class="uimnote"><?php _e('While Light will fit most of the themes, choose Dark if your WordPress theme has black or dark background.','profile-magic');?></div>
      </div>
     
        <div class="uimrow">
        <div class="uimfield">
          <?php _e( 'Automatically Redirect Author Page to their Profile?','profile-magic' ); ?>
        </div>
        <div class="uiminput">
          ...
          <div class="uimnote"><?php _e("When visitors accesses author page, they will be redirected to author's profile page.",'profile-magic');?></div>
      </div>
      
        <div class="uimrow">
        <div class="uimfield">
          <?php _e( 'Enable Gravatar','profile-magic' ); ?>
        </div>
        <div class="uiminput">
          ...
          <div class="uimnote"><?php printf(__('When enabled, if user has not uploaded a profile image, ProfileGrid will fetch profile image associated with user email on <a href="%s" target="_blank">Gravatar</a>, a WordPress service for uploading and managing user avatars.','profile-magic'),'https://gravatar.com');?></div>
      </div>
        
<!--      <div class="uimrow">
        <div class="uimfield">
          <?php _e( 'Make Primary Email Field Editable in Profile View','profile-magic' ); ?>
        </div>
        <div class="uiminput">
          ...
          <div class="uimnote"><?php _e('Users will see their registered email address as editable field while editing their profiles.','profile-magic');?></div>
      </div>-->
      
      <div class="uimrow">
        <div class="uimfield">
          <?php _e( 'Allow Dashboard Login Page Access to Guests','profile-magic' ); ?>
        </div>
        <div class="uiminput">
          ...
          <div class="uimnote"><?php _e("Users will be allowed to login using WordPress' default dashboard login page. When turned off, guests will be redirected to ProfileGrid login page when trying to access dashboard login page directly.",'profile-magic');?></div>
      </div>
      
        <div class="uimrow">
          <div class="uimfield">
            <?php _e( 'Allow Dashboard Register Page access to Guests','profile-magic' ); ?>
          </div>
          <div class="uiminput">
            ...
            <div class="uimnote"><?php _e("Users will be allowed to register using WordPress' default dashboard registration page. When turned off, guests will be redirected to ProfileGrid's default registration page when trying to access dashboard register page directly.",'profile-magic');?></div>
        </div>
      ...
      <div class="uimrow">
        <div class="uimfield">
          <?php _e( 'Hide WordPress Toolbar','profile-magic' ); ?>
        </div>
        <div class="uiminput">
          ...
          <div class="uimnote"><?php _e('Hides the top WordPress admin bar for logged in users.','profile-magic');?></div>
      </div>  
        <div class="childfieldsrow" id="pm_hide_admin_toolbar_html" style=" <?php if($dbhandler->get_global_option_value('pm_hide_wp_toolbar','no')== 'yes'){echo 'display:block;';} else { echo 'display:none;';} ?>">
                <div class="uimrow">
                  <div class="uimfield">
                    <?php _e( 'Keep it visible for admin','profile-magic' ); ?>
                  </div>
                <div class="uiminput">
                ...
                <div class="uimnote"><?php _e('Show WordPress admin bar only to admin users','profile-magic');?></div>
                </div> 
        </div>

      <div class="uimrow">
        <div class="uimfield">
          <?php _e( 'Set Limit for Password Reset Tries','profile-magic' ); ?>
        </div>
        <div class="uiminput">
          ...
          <div class="uimnote"><?php _e('Define number of times user can try to reset password.','profile-magic');?></div>
      </div>  
    ...
    <div class="childfieldsrow" id="pm_reset_password_limt_html" style=" <?php if($dbhandler->get_global_option_value('pm_enable_reset_password_limit',0)==1){echo 'display:block;';} else { echo 'display:none;';} ?>">
      <div class="uimrow">
        <div class="uimfield">
          <?php _e( 'Number of Allowed Tries','profile-magic' ); ?>
        </div>
        <div class="uiminput <?php if($dbhandler->get_global_option_value('pm_enable_reset_password_limit',0)==1){echo 'pm_required';} ?>">
         ...
         <div class="errortext"></div>
          ...
          <div class="uimnote"><?php _e('User will not be allowed to reset password more than this defined number. If exceeded, user will see an error next time he/ she tries to reset the password.','profile-magic');?></div>
      </div>  
        
        <div class="uimrow">
        <div class="uimfield">
          <?php _e( 'Disable Password Reset Rule for Admins','profile-magic' ); ?>
        </div>
        <div class="uiminput">
          ...
          <div class="uimnote"><?php _e('The password reset limit rule will not apply to the admin.','profile-magic');?></div>
      </div>  
      ...
      <div class="uimrow">
        <div class="uimfield">
          <?php _e( 'Allow Multiple Attachments','profile-magic' ); ?>
        </div>
        <div class="uiminput">
          ...
          <div class="uimnote"><?php _e('Allow users to attach more than one file to file upload fields.','profile-magic');?></div>
      </div>
      
      <div class="uimrow">
        <div class="uimfield">
          <?php _e( 'Default WP Registration Page:','profile-magic' ); ?>
        </div>
        <div class="uiminput">
        <?php 
	   $default_registration_url = $dbhandler->get_global_option_value('pm_default_regisration_page','0');
			$args = array(
				...
				'echo'             => 1,
				'show_option_none'      => __('Select Page','profile-magic'),
    			'option_none_value'     => 0, 
        ...
        <div class="uimnote"><?php _e('Redirect all registration links to this page on your site. This helps in hiding the default WP registration form.','profile-magic');?></div>
      </div>
      
      <div class="uimrow">
        <div class="uimfield">
          <?php _e( 'After Login Redirect User to:','profile-magic' ); ?>
        </div>
        <div class="uiminput">
        <?php 
	   $pm_redirect_after_login = $dbhandler->get_global_option_value('pm_redirect_after_login','0');
        ...
        <div class="uimnote"><?php _e('When the user logs in, he/ she will be redirected to this page. This is usually a member specific area, like user profile page.','profile-magic');?></div>
      </div>
      
      <div class="uimrow">
        <div class="uimfield">
          <?php _e( 'After Logout Redirect User to:','profile-magic' ); ?>
        </div>
        <div class="uiminput">
        <?php 
      ...
      <div class="uimrow">
        <div class="uimfield">
          <?php _e( 'All Groups Page:','profile-magic' ); ?>
        </div>
        <div class="uiminput">
        <?php 
	   $pm_groups_page = $dbhandler->get_global_option_value('pm_groups_page','0');
			$args = array('depth'=>0,'child_of'=>0,'selected'=> $pm_groups_page,'echo'=>1,'show_option_none'=>__('Select Page','profile-magic'),'option_none_value'=>0,
			'name'=>'pm_groups_page');
			wp_dropdown_pages($args); 
		?>
          <div class="errortext"></div>
        </div>
        <div class="uimnote"><?php _e('All Groups page displays all the groups on your site beautifully on a single page. A great way to allow visitors to decide and sign up for relevant group.','profile-magic');?></div>
      </div>
      
      <div class="uimrow">
        <div class="uimfield">
          <?php _e( 'Registration Page:','profile-magic' ); ?>
        </div>
        <div class="uiminput">
        <?php 
	   $pm_registration_page = $dbhandler->get_global_option_value('pm_registration_page','0');
			$args = array('depth'=>0,'child_of'=>0,'selected'=> $pm_registration_page,'echo'=>1,'show_option_none'=>__('Select Page','profile-magic'),'option_none_value'=>0,
			'name'=>'pm_registration_page');
			wp_dropdown_pages($args); 
		?>
          <div class="errortext"></div>
        </div>
        <div class="uimnote"><?php _e('This will add Username and Password fields to this form.','profile-magic');?> </div>
      </div>
      
      <div class="uimrow">
        <div class="uimfield">
          <?php _e( 'Profile Page:','profile-magic' ); ?>
        </div>
        <div class="uiminput">
        <?php 
	   $pm_user_profile_page = $dbhandler->get_global_option_value('pm_user_profile_page','0');
			$args = array('depth'=>0,'child_of'=>0,'selected'=> $pm_user_profile_page,'echo'=>1,'show_option_none'=>__('Select Page','profile-magic'),'option_none_value'=>0,
			'name'=>'pm_user_profile_page');
			wp_dropdown_pages($args); 
		?>
          <div class="errortext"></div>
        </div>
        <div class="uimnote"><?php _e('Default member profile page. Make sure it has profile shortcode pasted inside it.','profile-magic');?></div>
      </div>
      
      <div class="uimrow">
        <div class="uimfield">
          <?php _e( 'Login Page:','profile-magic' ); ?>
        </div>
        <div class="uiminput">
        <?php 
	   		$pm_user_login_page = $dbhandler->get_global_option_value('pm_user_login_page','0');
			$args = array('depth'=>0,'child_of'=>0,'selected'=> $pm_user_login_page,'echo'=>1,'show_option_none'=>__('Select Page','profile-magic'),'option_none_value'=>0,
			'name'=>'pm_user_login_page');
			wp_dropdown_pages($args); 
		?>
          <div class="errortext"></div>
        </div>
        <div class="uimnote"><?php _e('The page where users can log in. It should have the login shortcode pasted inside.','profile-magic');?></div>
      </div>
      
      <div class="uimrow">
        <div class="uimfield">
          <?php _e( 'Password Recovery Page:','profile-magic' ); ?>
        </div>
        <div class="uiminput">
        <?php 
	   		$pm_forget_password_page = $dbhandler->get_global_option_value('pm_forget_password_page','0');
			$args = array('depth'=>0,'child_of'=>0,'selected'=> $pm_forget_password_page,'echo'=>1,'show_option_none'=>__('Select Page','profile-magic'),'option_none_value'=>0,
			'name'=>'pm_forget_password_page');
			wp_dropdown_pages($args); 
		?>
          <div class="errortext"></div>
        </div>
        <div class="uimnote"><?php _e('This page will allows users to start password recovery process.','profile-magic');?></div>
      </div>
      ...
      <div class="uimrow">
        <div class="uimfield">
          <?php _e( 'Group Page:','profile-magic' ); ?>
        </div>
        <div class="uiminput">
        <?php 
	   		$pm_group_page = $dbhandler->get_global_option_value('pm_group_page','0');
			$args = array('depth'=>0,'child_of'=>0,'selected'=> $pm_group_page,'echo'=>1,'show_option_none'=>__('Select Page','profile-magic'),'option_none_value'=>0,
			'name'=>'pm_group_page');
			wp_dropdown_pages($args); 
		?>
          <div class="errortext"></div>
        </div>
        <div class="uimnote"><?php _e('Single group page where users can see group details and other members of the group.','profile-magic');?></div>
      </div>

        <div class="uimrow">
            <div class="uimfield">
              <?php _e( 'User Blog Submission Page:','profile-magic' ); ?>
            </div>
            <div class="uiminput">
            <?php 
                            $pm_submit_blog = $dbhandler->get_global_option_value('pm_submit_blog','0');
                            $args = array('depth'=>0,'child_of'=>0,'selected'=> $pm_submit_blog,'echo'=>1,'show_option_none'=>__('Select Page','profile-magic'),'option_none_value'=>0,
                            'name'=>'pm_submit_blog');
                            wp_dropdown_pages($args); 
                    ?>
              <div class="errortext"></div>
            </div>
            <div class="uimnote"><?php _e('Page from where users can submit new blog posts, which will then appear in Blogs tab of their profiles.','profile-magic');?></div>
        </div>
