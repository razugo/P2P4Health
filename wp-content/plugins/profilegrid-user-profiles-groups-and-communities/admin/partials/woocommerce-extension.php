        ...
        <div class="content">
            ...
            <div class="uimrow">
                ...
                <div class="update-nag">
                 <?php
                 echo sprintf(__('Display WooCommerce data beautifully inside User Profiles. Download our WooCommerce extension from <a target="_blank" href="%s">here.</a> ','profile-magic'),$url);
                 ?>
                </div>
            </div>
