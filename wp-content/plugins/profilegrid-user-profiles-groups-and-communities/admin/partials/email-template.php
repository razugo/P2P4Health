...
if(filter_input(INPUT_POST,'submit_tmpl'))
{
	...
	if (!wp_verify_nonce($retrieved_nonce, 'save_pm_add_email_tmpl' ) ) die( __('Failed security check','profile-magic') );
...
<div class="uimagic">
  <form name="pm_add_email_template" id="pm_add_email_template" method="post">
    ...
    <div class="content">
      ...
      <?php else: ?>
      <div class="uimheader">
        <?php _e( 'Edit Template','profile-magic' ); ?>
      </div>
      <?php endif; ?>
      ...
      <div class="uimrow">
        ...
        <div class="uimnote"><?php _e('Define a name for this template. Front-end user never sees this. Only for your reference.','profile-magic');?></div>
      </div>      
      <div class="uimrow">
        <div class="uimfield">
      ...
      <div class="uimrow">
        <div class="uimfield">
          <?php _e( 'Email Template','profile-magic' ); ?>
        </div>
        <div class="uiminput">
          <?php
	   if(!empty($row))
    ...
    'quicktags' => true
      ...
      <div class="buttonarea"> <a href="admin.php?page=pm_email_templates">
        ...
        <input type="submit" value="<?php _e('Save','profile-magic');?>" name="submit_tmpl" id="submit_tmpl" onClick="return add_group_validation()"  />
