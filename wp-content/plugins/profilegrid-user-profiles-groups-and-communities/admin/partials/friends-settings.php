...
if(filter_input(INPUT_POST,'submit_settings'))
{
	...
	if (!wp_verify_nonce($retrieved_nonce, 'save_friends_settings' ) ) die( __('Failed security check','profile-magic') );
...
<div class="uimagic">
  <form name="pm_user_settings" id="pm_user_settings" method="post">
    ...
    <div class="content">
      <div class="uimheader">
        <?php _e( 'Friends Integration','profile-magic' ); ?>
      </div>
      ...
      <div class="uimrow">
        <div class="uimfield">
          <?php _e( 'Allow/ Disallow Making Friends:','profile-magic' ); ?>
        </div>
        <div class="uiminput">
        ...
        <div class="uimnote"><?php _e('Toggle Friends functionality on/ off.','profile-magic');?></div>
      </div> 
      ...
      <div class="uimrow">
        <div class="uimfield">
          <?php _e( 'Allow sending request to person who rejected earlier request:','profile-magic' ); ?>
        </div>
        <div class="uiminput">
        ...
        <div class="uimnote"><?php _e('Allow resending of friend requests to users who have earlier rejected the request.','profile-magic');?></div>
      </div>
      ...
      <div class="uimrow">
        <div class="uimfield">
          <?php _e( 'After how many days?','profile-magic' ); ?>
        </div>
        <div class="uiminput">
        ...
        <div class="uimnote"><?php _e('Define number of days after which a user can resend friend request to another user who has earlier deleted his/ her request.','profile-magic');?></div>
      </div>
      </div>
