...
if(filter_input(INPUT_POST,'submit_settings'))
{
	...
	if (!wp_verify_nonce($retrieved_nonce, 'save_third_party_settings' ) ) die( __('Failed security check','profile-magic') );
...
<div class="uimagic">
  <form name="pm_security_settings" id="pm_security_settings" method="post">
    ...
    <div class="content">
      <div class="uimheader">
        <?php _e( 'Third Party Integrations','profile-magic' ); ?>
      </div>
      ...
      <div class="uimrow">
        <div class="uimfield">
          <?php _e( 'Allow User to Login using Facebook:','profile-magic' ); ?>
        </div>
        <div class="uiminput">
        ...
        <div class="uimnote"><?php _e("For your reference only. Not visible on front-end. Description can help you remember the purpose of the form.",'profile-magic');?></div>
      </div>
      ...
      <div class="uimrow">
        <div class="uimfield">
          <?php _e('Facebook App ID','profile-magic');?>
        </div>
        <div class="uiminput">
      ...
      <div class="uimrow">
        <div class="uimfield">
          <?php _e('Facebook App Secret','profile-magic');?>
        </div>
        <div class="uiminput">
