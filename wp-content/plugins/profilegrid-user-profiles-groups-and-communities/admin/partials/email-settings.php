...
if(filter_input(INPUT_POST,'submit_settings'))
{
	...
	if (!wp_verify_nonce($retrieved_nonce, 'save_email_settings' ) ) die( __('Failed security check','profile-magic') );
    ...
    <div class="content">
	  ...
	  ?>
        ...
        <ul class="uimradio pg-add-other-options" id="pm_radio_field_other_option_html">
            <li><a class="pm_click_add_option pg-add-options" maxlength="0" onClick="add_pm_admin_email_option()" onKeyUp="add_pm_admin_email_option()"><?php _e('Click to add option','profile-magic');?></a></li>
      </ul>
      ...
      <div class="uimrow">
        <div class="uimfield">
          <?php _e('Type of Encryption:','profile-magic');?>
        </div>
        <div class="uiminput">
      ...
      <a class="cancel_button" onclick="pm_test_smtp_connection()"><?php _e('Test','profile-magic');?></a>
