...
if(filter_input(INPUT_POST,'submit_section'))
{
	...
	if (!wp_verify_nonce($retrieved_nonce, 'save_pm_add_section' ) ) die( __('Failed security check','profile-magic') );
	...
	wp_redirect( esc_url_raw('admin.php?page=pm_profile_fields&gid='.$post['gid']) );exit;
}
...
if(filter_input(INPUT_POST,'duplicate'))
{
	...
	wp_redirect( esc_url_raw('admin.php?page=pm_profile_sections&gid='.$gid) );exit;
}
...
if(filter_input(INPUT_GET, 'action')=='delete')
{
	...
	wp_redirect( esc_url_raw('admin.php?page=pm_profile_fields&gid='.filter_input(INPUT_GET, 'gid')) );exit;
}
...
<div class="uimagic">
  <form name="pm_add_section" id="pm_add_section" method="post">
    ...
    <div class="content">
      ...
      <?php else: ?>
      <div class="uimheader">
        <?php _e( 'Edit Section','profile-magic' ); ?>
      </div>
      <?php endif; ?>
      ...
      <div class="uimrow">
        ...
        <div class="uimnote"><?php _e('Enter a new name for this Profile Section.','profile-magic');?></div>
      </div>
      ...
      <div class="uimrow">
        ...
        <div class="uimnote"><?php _e('Move this Profile section to another Group.','profile-magic');?></div>
      </div>
