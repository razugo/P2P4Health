...
<div class="pmagic"> 
  ...
  <div class="operationsbar">
    <div class="pmtitle">
      <?php _e('Membership Requests','profile-magic');?>
    </div>
   
    <div class="nav">
      <ul>
      
        <li class="pm_action_button"><input type="submit" name="approve" value="<?php _e("Approve",'profile-magic');?>" /></li>
        <li class="pm_action_button"><input type="submit" name="decline" value="<?php _e("Decline",'profile-magic');?>" /></li>
  ...
  <div class="pmagic-table"> 
    ...
    <table style="width:100%">
      <tr>
        ...
        <th><?php _e('Name','profile-magic');?></th>
        <th><?php _e('Email','profile-magic');?></th>
        <th><?php _e('Request Date','profile-magic');?></th>
        <th><?php _e('Group','profile-magic');?></th>
        <th>&nbsp;</th>
        <th>&nbsp;</th>
      </tr>
      <?php
                        if(!empty($results))
                        {
                            ...
                            foreach($results as $entry)
                            {
                                ...
                                if(!$user || empty($user))
                                {
                                    ...
                                    $avatar = get_avatar($user->user_email, 30 );
            ...
            <td><?php echo $groupname;?></td>
                      ...
                      <?php $i++;} 
                        ...
                        else
                        {
                            ...
                            {
                                 _e('If you have assigned Group Managers with Frontend Group Manager extension installed, they can Manage Group Membership requests for respective closed Groups from Group Management page. As a site Administrator, you too can approve or reject membership requests directly from the dashboard. This is helpful when you do not plan to assign Group Managers or do not have Frontend Group Manager extension installed.','profile-magic');
                            }
