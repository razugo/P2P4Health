...
//            if($is_pg_dashboard_page):
		...
		$error['email_exist'] = __('Sorry, email already exist.','profile-magic');
                ...
                $error['atleast_one_field'] = __('Select at least one field.','profile-magic');
                $error['seprator_not_empty'] = __('Seperator field can not be empty.','profile-magic');
                $error['choose_image'] = __('Choose Image','profile-magic');
                $error['valid_image'] = __('This is not a valid image','profile-magic');
                $error['valid_group_name'] = __('Please enter a valid group name.','profile-magic');
                $error['group_manager_first'] = __('You must define a Group Manager first, before making a Group closed.','profile-magic');
                $error['delete'] = __('Delete','profile-magic');
                $error['success'] = __('Success','profile-magic');
                $error['failure'] = __('Failure','profile-magic');
                $error['select_group'] = __('please select a group','profile-magic');
                $error['no_user_search'] = __('Sorry, no user with this username in this group.','profile-magic');
		...
		wp_localize_script( $this->profile_magic, 'pm_error_object',$error);
                ...
                $upload_requirements['error_min_cover_width'] = sprintf( __( 'Image dimensions are too small. Minimum size is %d by 300 pixels.','profile-magic' ),$upload_requirements['pg_cover_photo_minimum_width']);
...
//                endif;
	...
	{       
                add_menu_page(__('ProfileGrid','profile-magic'),__('ProfileGrid','profile-magic'),"manage_options","pm_manage_groups",array( $this, 'pm_manage_groups' ),'dashicons-groups');
		add_submenu_page("",__('New Group','profile-magic'),__('New Group','profile-magic'),"manage_options","pm_add_group",array( $this, 'pm_add_group' ));
		add_submenu_page("",__('Profile Fields','profile-magic'),__('Profile Fields','profile-magic'),"manage_options","pm_profile_fields",array( $this, 'pm_profile_fields' ));
		add_submenu_page("",__('New Field','profile-magic'),__('New Field','profile-magic'),"manage_options","pm_add_field",array( $this, 'pm_add_field' ));
		add_submenu_page("",__('New Section','profile-magic'),__('New Section','profile-magic'),"manage_options","pm_add_section",array( $this, 'pm_add_section' ));
		add_submenu_page("pm_manage_groups",__('User Profiles','profile-magic'),__('User Profiles','profile-magic'),"manage_options","pm_user_manager",array( $this, 'pm_user_manager' ));
                add_submenu_page("pm_manage_groups",__('Requests','profile-magic'),__('Requests','profile-magic'),"manage_options","pm_requests_manager",array( $this, 'pm_requests_manager' ));
		add_submenu_page("",__('Profile View','profile-magic'),__('Profile View','profile-magic'),"manage_options","pm_profile_view",array( $this, 'pm_profile_view' ));
		add_submenu_page("",__('Edit User','profile-magic'),__('Edit User','profile-magic'),"manage_options","pm_user_edit",array( $this, 'pm_user_edit' ));
		add_submenu_page("pm_manage_groups",__('Email Templates','profile-magic'),__('Email Templates','profile-magic'),"manage_options","pm_email_templates",array( $this, 'pm_email_templates' ));
		add_submenu_page("pm_manage_groups",__('Add Email Template','profile-magic'),__('Add Email Template','profile-magic'),"manage_options","pm_add_email_template",array( $this, 'pm_add_email_template' ));
		add_submenu_page("",__('Email Preview','profile-magic'),__('Email Preview','profile-magic'),"manage_options","pm_email_preview",array($this,'pm_email_preview'));
		add_submenu_page("",__('Analytics','profile-magic'),__('Analytics','profile-magic'),"manage_options","pm_analytics",array( $this, 'pm_analytics' ));
		add_submenu_page("",__('Membership','profile-magic'),__('Membership','profile-magic'),"manage_options","pm_membership",array( $this, 'pm_membership' ));
		add_submenu_page("pm_manage_groups",__('Shortcodes','profile-magic'),__('Shortcodes','profile-magic'),"manage_options","pm_shortcodes",array( $this, 'pm_shortcodes' ));
                add_submenu_page("pm_manage_groups",__('Global Settings','profile-magic'),__('Global Settings','profile-magic'),"manage_options","pm_settings",array( $this, 'pm_settings' ));
		add_submenu_page("",__('General Settings','profile-magic'),__('General Settings','profile-magic'),"manage_options","pm_general_settings",array( $this, 'pm_general_settings' ));
		add_submenu_page("",__('Anti Spam Settings','profile-magic'),__('Anti Spam Settings','profile-magic'),"manage_options","pm_security_settings",array( $this, 'pm_security_settings' ));
		add_submenu_page("",__('User Accounts Settings','profile-magic'),__('User Accounts Settings','profile-magic'),"manage_options","pm_user_settings",array( $this, 'pm_user_settings' ));
		add_submenu_page("",__('Email Settings','profile-magic'),__('Email Settings','profile-magic'),"manage_options","pm_email_settings",array( $this, 'pm_email_settings' ));
		add_submenu_page("",__('Third Party Integrations','profile-magic'),__('Third Party Integrations','profile-magic'),"manage_options","pm_third_party_settings",array( $this, 'pm_third_party_settings' ));
                add_submenu_page("",__('Payments Settings','profile-magic'),__('Payments Settings','profile-magic'),"manage_options","pm_payment_settings",array( $this, 'pm_payment_settings' ));
                add_submenu_page("",__('Tools','profile-magic'),__('Tools','profile-magic'),"manage_options","pm_tools",array( $this, 'pm_tools' ));
                add_submenu_page("",__('Export Users','profile-magic'),__('Export Users','profile-magic'),"manage_options","pm_export_users",array( $this, 'pm_export_users' ));
                add_submenu_page("",__('Import Users','profile-magic'),__('Import Users','profile-magic'),"manage_options","pm_import_users",array( $this, 'pm_import_users' ));
                add_submenu_page("",__('Blog Settings','profile-magic'),__('Blog Settings','profile-magic'),"manage_options","pm_blog_settings",array( $this, 'pm_blog_settings' ));
                add_submenu_page("",__('Message Settings','profile-magic'),__('Message Settings','profile-magic'),"manage_options","pm_message_settings",array( $this, 'pm_message_settings' ));
                add_submenu_page("",__('Friends Settings','profile-magic'),__('Friends Settings','profile-magic'),"manage_options","pm_friend_settings",array( $this, 'pm_friend_settings' ));
                add_submenu_page("",__('Upload Settings','profile-magic'),__('Upload Settings','profile-magic'),"manage_options","pm_upload_settings",array( $this, 'pm_upload_settings' ));
                add_submenu_page("",__('SEO Settings','profile-magic'),__('SEO Settings','profile-magic'),"manage_options","pm_seo_settings",array( $this, 'pm_seo_settings' ));
                add_submenu_page("",__('Export Options','profile-magic'),__('Export Options','profile-magic'),"manage_options","pm_export_options",array( $this, 'pm_export_options' ));
                add_submenu_page("",__('Import Options','profile-magic'),__('Import Options','profile-magic'),"manage_options","pm_import_options",array( $this, 'pm_import_options' ));
                add_submenu_page("",__('Content Restrictions','profile-magic'),__('Content Restrictions','profile-magic'),"manage_options","pm_content_restrictions",array( $this, 'pm_content_restrictions' ));
                add_submenu_page("",__('Woocommerce Extension','profile-magic'),__('Woocommerce Extension','profile-magic'),"manage_options","pm_woocommerce_extension",array( $this, 'pm_woocommerce_extension' ));                             
                add_submenu_page("",__('RegistrationMagic Integrations','profile-magic'),__('RegistrationMagic Integrations','profile-magic'),"manage_options","pm_rm_integration",array( $this, 'pm_rm_integration' ));
	...
	public function profile_magic_check_smtp_connection()
	{
		...
		$to = $dbhandler->get_global_option_value('pm_smtp_test_email_address');
                //echo $to;die;
		echo wp_mail( $to,__('Test SMTP Connection','profile-magic'),'Test');die;
	...
	public function profile_magic_show_user_fields($user)
	{
                ...
                {
                    $message2 = sprintf( __( 'File Restrictions: Please make sure your image size fits within %d by %d pixels.','profile-magic' ),$pg_cover_photo_minimum_width,300);
                }
                else
                {
                    $message2 = sprintf( __( 'File Restrictions: Please make sure your image size fits within %d by %d pixels and does not exceeds total size of %d bytes.','profile-magic' ),$pg_cover_photo_minimum_width,300,$pg_cover_image_max_file_size);
                }
   ...
   ?>
                ...
                <tbody>
                        <tr>
                            ...
                            <td class="pm-field-input">              
                                ...
                                <?php echo get_avatar($user->user_email,100,'',false,array('class'=>'pm-user user-profile-image','id'=>'pg_upload_image_preview'));?>
                                <input type="button" name="pg_remove_image" id="pg_remove_image" class="button" value="<?php _e('Remove','profile-magic');?>" onclick="pg_remove_profile_image()"/>
                                </span>
                        ...
                        <tr>
                            ...
                            <th class="pm-field-lable">
                                <label for="pm_field_37"><?php _e('Cover Image', 'profile-magic'); ?></label>
                            </th>
                            <td class="pm-field-input">              
                                ...
                                <input id="cover_image_button" name="cover_image_button" class="button cover_image_button" type="button" value="<?php _e('Upload Image', 'profile-magic'); ?>" />
                                ...
                                <input type="button" name="pg_remove_cover_image" id="pg_remove_cover_image" class="button" value="<?php _e('Remove','profile-magic');?>" onclick="pm_remove_cover_image()"/>
                                </span>
                           ...
                           <th class="pm-field-lable">
                            ...
                            <td class="pm-field-input">              
                                 <select name="pm_profile_privacy" id="pm_profile_privacy">
                                    <option value="1" <?php selected($pm_profile_privacy,'1'); ?>><?php _e('Everyone','profile-magic');?></option>
                                    <option value="2" <?php selected($pm_profile_privacy,'2'); ?>><?php _e('Friends','profile-magic');?></option>
                                    <option value="3" <?php selected($pm_profile_privacy,'3'); ?>><?php _e('Group Members','profile-magic');?></option>
                                    <option value="4" <?php selected($pm_profile_privacy,'4'); ?>><?php _e('Friends &amp; Group Members','profile-magic');?></option>
                                    <option value="5" <?php selected($pm_profile_privacy,'5'); ?>><?php _e('Only Me','profile-magic');?></option>
                                </select>
                            </td> 
                        </tr>
                        <?php } ?>
            ...
            <table class="form-table">        
                        <tr>
                            ...
                            <th class="pm-field-lable">
                                <label for="pm_field_37"><?php _e('User Group(s)', 'profile-magic'); ?></label>
                            </th>
                            <td class="pm-field-input">              
                                ...
                                <p class="description"><?php _e('Press ctrl or ⌘ (in Mac) while clicking to assign multiple ProfileGrid Groups','profile-magic') ?></p>
                                <div class="errortext" style="display:none;"></div>
                            </td>
                        </tr>
                    </table>
	...
	public function profile_magic_update_user_fields($user_id )
	{
		...
		if(!isset($_POST['reg_form_submit']))
		{
			update_user_meta($user_id, 'pm_user_avatar', $_POST['pm_user_avatar']);
                        update_user_meta($user_id, 'pm_cover_image', $_POST['pm_cover_image']);
       ...
       wp_redirect( esc_url_raw( $redirect_url ) );exit;
        ...
        public function profile_magic_verify_update_user() {
            ...
            if(post_exists($user_meta['first_name'][0]) != 0 ) {
            ...
            $post_meta['address'] = $user_meta['pm_field_14'][0];
            $post_meta['city'] = $user_meta['pm_field_32'][0];
            $post_meta['state'] = $user_meta['pm_field_30'][0];
            $post_meta['postal_code'] = $user_meta['pm_field_28'][0];
            $post_meta['zip'] = $user_meta['pm_field_28'][0];
            $post_meta['country'] = $user_meta['pm_field_33'][0];
            $post_meta['phone'] = $user_meta['pm_field_23'][0];
            $post_meta['url'] = $user_info->data->user_url;
            $post_meta['profile_url'] = "/pm_profile?uid=" . $uid;
            $post_meta['category']= $user_meta['pm_field_35'][0];
            ...
            <div id="pg-deactivate-feedback-dialog-wrapper" class="pg-modal-view" style="display: none">
               ...
               <div class="pg-modal-wrap pg-deactivate-feedback"> 
                   <div class="pg-modal-titlebar">
                               <div class="pg-modal-title"><?php _e('ProfileGrid Feedback','profile-magic');?> </div>
                ...
                <div class="uimrow">
                <div id="pg-deactivate-feedback-dialog-form-caption"><?php _e('If you have a moment, please share why you are deactivating ProfileGrid:','profile-magic');?></div>
                <div id="pg-deactivate-feedback-dialog-form-body">
                    <div class="pg-deactivate-feedback-dialog-input-wrapper">
                        ...
                        <label for="pg-deactivate-feedback-feature_not_available" class="pg-deactivate-feedback-dialog-label"><span class="pg-feedback-emoji">&#x1f61e;</span><?php _e("Doesn't have the feature I need","profile-magic");?></label>
                        <div class="pginput" id="pg_reason_feature_not_available" style="display:none"><input class="pg-feedback-text" type="text" name="pg_reason_feature_not_available" placeholder="<?php _e("Please let us know the missing feature...","profile-magic");?>"></div>
                    </div>
                    <div class="pg-deactivate-feedback-dialog-input-wrapper">
                        ...
                        <label for="pg-deactivate-feedback-feature_not_working" class="pg-deactivate-feedback-dialog-label"><span class="pg-feedback-emoji">&#x1f615;</span><?php _e("One of the features didn't worked","profile-magic");?></label>
                        <div class="pginput" id="pg_reason_feature_not_working" style="display:none"><input class="pg-feedback-text" type="text" name="pg_reason_feature_not_working" placeholder="<?php _e("Please let us know the feature, like 'emails notifications'","profile-magic");?>"></div>
                    </div>
                    <div class="pg-deactivate-feedback-dialog-input-wrapper">
                        ...
                        <label for="pg-deactivate-feedback-found_a_better_plugin" class="pg-deactivate-feedback-dialog-label"><span class="pg-feedback-emoji">&#x1f60a;</span><?php _e("Moved to a different plugin","profile-magic");?></label>
                        <div class="pginput" id="pg_reason_found_a_better_plugin" style="display:none"><input class="pg-feedback-text" type="text" name="pg_reason_found_a_better_plugin" placeholder="<?php _e("Could you please share the plugin's name","profile-magic");?>"></div>
                    </div>
                    <div class="pg-deactivate-feedback-dialog-input-wrapper">
                        ...
                        <label for="pg-deactivate-feedback-plugin_broke_site" class="pg-deactivate-feedback-dialog-label"><span class="pg-feedback-emoji">&#x1f621;</span><?php _e("The plugin broke my site","profile-magic");?></label>
                    </div>
                    <div class="pg-deactivate-feedback-dialog-input-wrapper">
                        ...
                        <label for="pg-deactivate-feedback-plugin_stopped_working" class="pg-deactivate-feedback-dialog-label"><span class="pg-feedback-emoji">&#x1f620;</span><?php _e("The plugin suddenly stopped working","profile-magic");?></label>
                    </div>
                    <div class="pg-deactivate-feedback-dialog-input-wrapper">
                        ...
                        <label for="pg-deactivate-feedback-temporary_deactivation" class="pg-deactivate-feedback-dialog-label"><span class="pg-feedback-emoji">&#x1f60a;</span><?php _e("It's a temporary deactivation","profile-magic");?></label>
                    </div>
                    ...
                    <div class="pg-deactivate-feedback-dialog-input-wrapper">
                        ...
                        <label for="pg-deactivate-feedback-other" class="pg-deactivate-feedback-dialog-label"><span class="pg-feedback-emoji">&#x1f610;</span><?php _e("Other","profile-magic");?></label>
                        <div class="pginput" id="pg_reason_other"  style="display:none"><input class="pg-feedback-text" type="text" name="pg_reason_other" placeholder="<?php _e("Please share the reason","profile-magic");?>"></div>
                    </div>
                </div>
                          ...
                          <div class="pg-ajax-loader" style="display:none">
                              <i class="fa fa-spinner fa-pulse fa-3x fa-fw"></i>
                                <span class=""><?php _e("Loading...","profile-magic");?></span>
                                </div>
                       
                       <div class="pg-modal-footer uimrow">
                                <input type="button" id="pg-feedback-btn" value="<?php _e("Submit & Deactivate","profile-magic");?>"/>
                                <input type="button" id="pg-feedback-cancel-btn" value="<?php _e("Cancel","profile-magic");?>"/>
                                </div>
    ...
    public function pm_dismissible_woocommerce_notice()
    {
         ...
         if (class_exists('Profile_Magic') &&  class_exists('WooCommerce') && !class_exists('Profilegrid_Woocommerce') ) {
            ...
            <p><?php echo sprintf(__( "If you wish to integrate WooCommerce data with ProfileGrid user profiles, please download WooCommerce extension from <a target='_blank' href='%s'>here.</a>", 'profile-magic' ),$url); ?></p>
            </div>
        <?php
         }
    }
    ...
    public function pm_dismissible_custom_profile_tab_notice()
    {
        $dbhandler = new PM_DBhandler;
         ...
         if (class_exists('Profile_Magic') &&  class_exists('WooCommerce') && class_exists('Profilegrid_Woocommerce') && !class_exists('Profilegrid_User_Content') ) {
            ...
            <p><?php echo sprintf(__( "Do you wish to display information from WooCommerce extensions and other WordPress plugins inside frontend user profiles? Try our Custom Profile Tabs extension, which can turn user profiles into powerful hubs with all user specific information in one place! <a target='_blank' href='%s'>Get it here.</a>", 'profile-magic' ),$url); ?></p>
            </div>
        <?php
         }
    }
    ...
    public function pm_dismissible_bbpress_notice()
    {
        $dbhandler = new PM_DBhandler;
         ...
         if (class_exists('Profile_Magic') &&  is_plugin_active( 'bbpress/bbpress.php' ) && class_exists('Profilegrid_Bbpress') && !class_exists('Profilegrid_User_Content') ) {
            ...
            <p><?php echo sprintf(__( "Do you wish to display information from bbPress extensions and other WordPress plugins inside frontend user profiles? Try our Custom Profile Tabs extension, which can turn user profiles into powerful hubs with all user specific information in one place! <a target='_blank' href='%s'>Get it here.</a>", 'profile-magic' ),$url); ?></p>
            </div>
        <?php
         }
    }
    ...
    public function pm_dismissible_rm_form_type_changed()
    {
        ...
        if(!empty($get_value)) {
            ...
            <div class="notice notice-info is-dismissible pgrm-dismissible" id="pg_rm_change_form_type_<?php echo $form_id;?>" data-rmid="<?php echo $form_id;?>">
                            <p><?php echo sprintf(__("%s registration form has been reverted to default ProfileGrid form since the associated RegistrationMagic form was deleted or its type was changed.",'profile-magic'),$name);  ?></p>
                        </div>
                    <?php
                }
            }
    ...
    public function pg_create_group_page()
    {
        ...
        $arg = array('post_type' => 'page','post_title' =>$group_name,'post_status' => 'draft','post_content' => '[PM_Group id="'.$gid.'"]');
