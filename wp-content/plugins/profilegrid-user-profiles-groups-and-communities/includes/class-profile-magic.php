...
class Profile_Magic {
	...
	public function __construct() {
		...
		$this->profile_magic = 'profile-magic';
		$this->version = '1.0.0';
	...
	private function define_access_hooks()
	{
        ...
        private function define_notification_hooks()
        {
            ...
            $this->loader->add_action('publish_pg_groupwalls', $plugin_notification,'pg_wallpost_published_notification',10,2);
        }
	...
	private function define_public_hooks() 
	{
		...
		$this->loader->add_filter('get_avatar',$plugin_public, 'profile_magic_get_avatar',100000000,6);
                //$this->loader->add_filter('avatar_defaults', $plugin_public,'profile_magic_default_avatar');
		...
		$this->loader->add_action('wp_ajax_pm_get_friends_notification',$plugin_public,'pm_get_friends_notification');
                ...
                $this->loader->add_action('profile_magic_profile_tab',$plugin_public, 'pm_show_settings_tab',10000,2);
                $this->loader->add_action('profile_magic_profile_tab_content',$plugin_public, 'pm_show_settings_content',10000,2);
		$this->loader->add_filter('get_comment_author',$plugin_public,'pm_comment_author',9999999,2);
