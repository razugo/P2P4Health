...
class PM_Friends_Functions {
	...
	{	
		...
		$identifier = 'FRIENDS';
		$where = array('user1'=>$uid,'status'=>2);
	...
	{	
		...
		$identifier = 'FRIENDS';
                if($send==1)
                {
                    $where = array('user1'=>$uid,'status'=>1);
                }
                else
                {
		...
		//$additional = "or user2=$uid and status=1";
	...
	{	
		...
		//
		if(empty($friends_of_friends)) $friends_of_friends=array();
	...
	public function profile_magic_friends_result_html($users,$uid,$view=1)
	{
		...
		foreach($users as $entry):
			...
			//$profile_url = $profile_page.$sign.'uid='.$entry->ID;
            ...
            <div class="pm-myfriends-list-wrap pm-difl">
                ...
                <?php echo get_avatar($entry->user_email, 85 );?>
                ...
                <div class="pm-friend-info pm-dbfl">
                                <span class="pm-friend-status <?php echo $login_status;?>"></span>
                                <div class="pm-friend-name "><a href="<?php echo $profile_url;?>"><?php echo $pmrequests->pm_get_display_name($entry->ID);?></a></div>
                            </div> 
            ...
            if($dbhandler->get_global_option_value('pm_enable_private_messaging','1')==1):
                ...
                ?>
                    <div class="pm-friend-message-button">
                      <a id="pm-message-url" class="pm-color" href="<?php echo $messenger_url; ?>" ><?php _e('Message','profile-magic');?></a>
                    </div>
                <?php endif; 
        }
        ...
        {
            ?>
                <div class="pm-friend-message-Remove"><a onclick="pm_unfriend_request('<?php echo $u1;?>','<?php echo $u2;?>',this)" ><?php _e('Remove','profile-magic');?></a></div>
            <?php
        }
            ...
            ?>
               <div class="pm-friend-select">
                          <label class="pm-color"> 
                              <input type="checkbox" name="<?php echo $class.'[]';?>" id="<?php echo $class;?>" class="pm-friends-select-checkbox <?php echo $class;?>" value="<?php echo $u2;?>" onclick="pm_select_friend_checkbox(this)" /> <?php _e('Select','profile-magic');?>
                        </label>
                    </div>
            <?php
        }
        ...
        {
            ?>
                <div class="pm-friend-message-button pm-friend-accept_button"><a onclick="pm_confirm_request('<?php echo $u1;?>','<?php echo $u2;?>',this)" ><?php _e('Accept','profile-magic');?></a></div>
            <?php
        }
        ...
        {
            ?>
                <div class="pm-friend-message-Remove pm-friend-reject_button"><a onclick="pm_reject_friend_request('<?php echo $u1;?>','<?php echo $u2;?>',this)" ><?php _e('Delete','profile-magic');?></a></div>
            <?php
        }
        ...
        {
            ?>
                <div class="pm-friend-message-Remove pm-friend-cancel_button"><a onclick="pm_cancel_request('<?php echo $u1;?>','<?php echo $u2;?>',this)" ><?php _e('Cancel','profile-magic');?></a></div>
            <?php
        }
	...
	public function profile_magic_friend_list_button($user1,$user2,$action=0)
	{
            ...
            if(isset($exist_in_table))
            {
                switch($exist_in_table->status)
                {
                        case 1:
                                ...
                                {
                                    ?>
                                    <span class="pm-color pm_add_friend_request" onclick="pm_cancel_request_rightside('<?php echo $u1;?>','<?php echo $u2;?>',this)"><?php _e('Cancel Request','profile-magic');?></span>
                                    <?php
                                }
                                else
                                {
                                    ?>
                                    <span class="pm-color pm_add_friend_request" onclick="pm_confirm_request_right_side('<?php echo $u1;?>','<?php echo $u2;?>',this)"><?php _e('Accept','profile-magic');?></span>
                                    <span class="pm-color pm_add_friend_request" onclick="pm_reject_friend_request_right_side('<?php echo $u1;?>','<?php echo $u2;?>',this)"><?php _e('Delete','profile-magic');?></span>
                                    <?php
                                }	
                                break;
                        case 2:
                                ?>
                                <span class="pm-color pm_add_friend_request" onclick="pm_unfriend_request_rightside('<?php echo $u1;?>','<?php echo $u2;?>',this)"><?php _e('UnFriend','profile-magic');?></span>
                                <?php
                                break;
                        case 3:
                        ...
                        case 6:
                                if($dbhandler->get_global_option_value('pm_allow_sending_request_to_rejected_person','0')==1):
                                        ...
                                        if($days > 0)
                                        {
                                            ...
                                            {
                                                ?>
                                                <span class="pm_add_friend_request" onclick="pm_add_friend_request('<?php echo $u1;?>','<?php echo $u2;?>',this)"><?php _e("Add Friend","profile-magic");?></span>
                                                <?php
            ...
            else
            {
                ...
                if(is_user_logged_in()):
                    ?>
                                <span class="pm-color pm-add-friend" onclick="pm_add_friend_request('<?php echo $u1;?>','<?php echo $u2;?>',this)"><?php _e("Add Friend","profile-magic");?></span>
                <?php
                else:
                    ...
                    ?>
                            <span><a href="<?php echo $login_url;?>"><?php echo __("Add Friend","profile-magic");?></a></span>
                    <?php
                endif;
            }
	}
	...
	public function profile_magic_is_exist_in_table($user1,$user2)
	{
		$dbhandler = new PM_DBhandler;
		$identifier = 'FRIENDS';
		$where = array('user1'=>$user1,'user2'=>$user2);
	...
	public function profile_magic_is_my_friends($user1,$user2)
	{
		$dbhandler = new PM_DBhandler;
		$identifier = 'FRIENDS';
		$where = array('user1'=>$user1,'user2'=>$user2,'status'=>2);
	...
	public function profile_magic_is_removed_suggestion($user1,$user2)
	{
		$dbhandler = new PM_DBhandler;
		$identifier = 'FRIENDS';
		$where = array('user1'=>$user1,'user2'=>$user2,'status'=>5);
	...
	public function profile_magic_is_reject_request($user1,$user2)
	{
		$dbhandler = new PM_DBhandler;
		$identifier = 'FRIENDS';
		$where = array('user1'=>$user1,'user2'=>$user2,'status'=>3);
	...
	public function profile_magic_is_owner_requested($user1,$user2)
	{
		$dbhandler = new PM_DBhandler;
		$identifier = 'FRIENDS';
		$where = array('user1'=>$user1,'user2'=>$user2,'status'=>1);
		//$additional = "OR user1=$user2 AND user2=$user1 AND status=1";
	...
	public function profile_magic_is_viewver_requested($user1,$user2)
	{
		$dbhandler = new PM_DBhandler;
		$identifier = 'FRIENDS';
		$where = array('user2'=>$user1,'user1'=>$user2,'status'=>1);
		//$additional = "OR user1=$user2 AND user2=$user1 AND status=1";
		$is_friend = $dbhandler->get_all_result($identifier,'id', $where,'var',0,false,null,false);
		return $is_friend;	
	}
	...
	public function profile_magic_is_viewver_blocked($user1,$user2)
	{
		$dbhandler = new PM_DBhandler;
		$identifier = 'FRIENDS';
		$where = array('user2'=>$user1,'user1'=>$user2,'status'=>4);
		//$additional = "OR user1=$user2 AND user2=$user1 AND status=1";
		$is_friend = $dbhandler->get_all_result($identifier,'id', $where,'var',0,false,null,false);
		return $is_friend;	
	}
	...
	public function profile_magic_is_owner_blocked($user1,$user2)
	{
		$dbhandler = new PM_DBhandler;
		$identifier = 'FRIENDS';
		$where = array('user1'=>$user1,'user2'=>$user2,'status'=>4);
		//$additional = "OR user1=$user2 AND user2=$user1 AND status=1";
		$is_friend = $dbhandler->get_all_result($identifier,'id', $where,'var',0,false,null,false);
		return $is_friend;	
	}
